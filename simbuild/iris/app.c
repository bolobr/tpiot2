...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fcc686f46b0, const void *arg_0x7fcc686f4988);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x7fcc68676060) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x7fcc68445ca8), 
int (*key_eq_fn)(void *arg_0x7fcc684444e8, void *arg_0x7fcc68444788));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fcc682439b0, int arg_0x7fcc68243c18);
static double RandomUniform(void );
...
uint8_t len);
# 64 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void TpiotC$MilliTimer$startPeriodic(uint32_t dt);
# 64 "TpiotC.nc"
message_t TpiotC$packet[1000];
int TpiotC$parent[1000];
...
static inline error_t /*TpiotAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
# 78 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7fcc67e3a340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fcc67e3a340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7fcc67e3a340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7fcc67e39020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7fcc67e39020, msg, payload, len);
#line 78
...
# 64 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void TpiotC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      TpiotC$MilliTimer$startPeriodic(250);
    }
  else {
...
#line 104
{
  sim_log_debug(152U, "RadioCountToLedsC", "RadioCountToLedsC: packet sent.\n", 1);
}
...
# 110 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7fcc67e3b220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7fcc67e3b220, msg, error);
#line 110
}
#line 110
...
# 100 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7fcc6793e480, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fcc6793e480) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7fcc6793e480, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7fcc68131158){
#line 75
  switch (arg_0x7fcc68131158) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7fcc68131158);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7fcc6793d650, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7fcc6793d650, addr, msg, len);
#line 80
...
#line 81
{
  ...
  if (TpiotC$AMSend$send(AM_BROADCAST_ADDR, &TpiotC$packet[sim_node()], 10) == SUCCESS) {
...
# 83 "/home/guilherme/Downloads/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7fcc679d4da0){
#line 83
  switch (arg_0x7fcc679d4da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7fcc679d4da0);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "TpiotC$parent"))
  {
    *addr = (uintptr_t)&TpiotC$parent[__nesc_mote];
    *size = sizeof(TpiotC$parent[__nesc_mote]);
    return 0;
  }
